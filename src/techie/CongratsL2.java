 ...
 * @author ragha
 */
public class CongratsL2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PassedLevelLabel.setText("You Passed the Second Level !");
        getContentPane().add(PassedLevelLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 200, 40));
        ...
        YouCollectedLabel.setText("You  have Collected");
        getContentPane().add(YouCollectedLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, -1, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CongratsL2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CongratsL2().setVisible(true);
            }
        });
    }
